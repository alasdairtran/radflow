...
@Model.register('wiki_time_series_lstm_network_daily')
class WikiTimeSeriesLSTMNetworkDaily(BaseModel):
    def __init__(self,
                 vocab: Vocabulary,
                 decoder: Decoder,
                 data_dir: str,
        ...
        if agg_type == 'attention':
            ...
            self.conv1 = HypergraphConv(self.hidden_size, self.hidden_size,
                                        use_attention=False)
