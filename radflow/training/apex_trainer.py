...
from allennlp.training import BatchCallback, EpochCallback, Trainer
...
@Trainer.register("apex_gradient_descent", constructor="from_partial_objects")
class ApexGradientDescentTrainer(Trainer):
    """
    ...
    def __init__(
        ...
        keep_batchnorm_fp32: Optional[bool] = False,
    ) -> None:
    ...
    def rescale_gradients(self) -> float:
        ...
        if self._grad_norm:
            ...
            return torch.norm(
                torch.stack([torch.norm(p.grad.detach())
                             for p in parameters_to_clip])
            )
    ...
    def train(self) -> Dict[str, Any]:
        ...
        for epoch in range(epoch_counter, self._num_epochs):
            ...
            # The Scheduler API is agradflowtic to whether your schedule requires a validation metric -
